...
export class Widget extends Component {
    ...
    render() {
        return (
            <div className='justify-between items-center flex flex-col bg-white rounded-lg focus:ring-green-400 ring-1 ring-gray-300 m-10 w-52 h-80 p-8 cursor-pointer hover:ring-[3px] hover:shadow-2xl transition ease-in-out duration-300 group'>
