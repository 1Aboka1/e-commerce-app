...
export class WelcomeSection extends Component {
    ...
    render() {
        return (
            <div className={'h-screen bg-gray-500 bg-center bg-no-repeat bg-cover bg-blend-multiply'} style={{backgroundImage: `url("http://172.20.0.1:8000/static/6424672.jpg")`}}>
