...
export class WelcomeSection extends Component {
    ...
    render() {
        return (
            <div className={'h-screen bg-gray-100 bg-[url("https://media.istockphoto.com/photos/home-appliancess-set-of-household-kitchen-technics-in-the-new-or-picture-id952839420?k=20&m=952839420&s=612x612&w=0&h=W1YiB_4DuiBFQVAUPlPY2ynLpVHzocKKtf6Vp22CwjM="))]'}>
                <div className='flex flex-col items-center gap-6 justify-center h-[75vh] '>
                    ...
                    <div className='flex space-x-3 w-full justify-center'>
                        <button onClick={this.props.handleSearchClick} className='rounded-lg px-4 py-3 ring-1 ring-gray-200 bg-green-500 text-white font-bold hover:bg-green-600 hover:scale-110 hover:ring-black transition ease-in-out duration-300'>Поиск</button>
                        <button onClick={this.togglePop} className='rounded-lg px-4 py-3 ring-1 ring-gray-300 bg-white font-bold hover:bg-gray-200 hover:ring-black hover:scale-110 transition ease-in-out duration-200'>Категории</button>
                    </div>
